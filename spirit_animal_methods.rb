...
def get_scenarios
    ...
    "You are at a party with a few friends, and many people you don't know. What do you do?\n\nOptions:\n1. Hang out with the people you already know\n2. Meet some new people",
    "You are playing a casual game of mario kart with your spouse. You are winning until you are hit by a blue shell right before the finish line and end up losing. Your spouse points at you, laughs, and jumps up in glee. What do you do?\n\nOptions:\n1. Demand a rematch to reclaim your honour\n2. Let your spouse known that gloating is not an appropriate way to celebrate a win\n3. Congratulate them on their win",
    "Your neighbour plays music loudly in the middle of the night. It disturbs your sleep and you are unable to focus in the next day's Ruby class, getting many answers wrong in the Kahoot. This continues for several nights. What do you do?\n\nOptions:\n1. Knock on your neighbour's door to ask them face-to-face to stop\n2. Leave a note asking them to stop\n3. Accept it and buy some earplugs"
    ]
end
